  ...
  <div class="paper">
          ...
          <div class="current-style">
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" v-model="role" placeholder="Enter Role">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="phone">Phone:</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" v-model="phone" placeholder="Enter Your Phone Number">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="country">Country:</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" v-model="country" placeholder="Enter Your Country">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="referred">Referred Name:</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" v-model="referred" placeholder="Enter Referred Name">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="university">University:</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" v-model="university" placeholder="Enter University">
                </div>
              </div>
              <div class="actions" @click="saveCustomer">
    ...
    <div class="project-toolbar">
      <div class="left">
        ...
        <button @click="toggleFilterReferencesMenu" ref="filterReferencesMenuBtn" class="filter-references-menu-btn">
          <span>
    ...
    <div id="references">
      <ul mode="out-in" v-for="customer in customers">
        <li draggable="true" class="row">
